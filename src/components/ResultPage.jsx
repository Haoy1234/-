  ...
  return (
    <div className="min-h-screen bg-gray-100 flex items-center justify-center p-4">
      ...
      >
        {/* 新的背景图片 - 完整覆盖 */}
        <img 
          src="/Huang_xiao_xian/images/背景_画板 1.png"
          alt="背景"
          style={{
            position: 'absolute',
            width: '597px',
        ...
        {/* Logo图标 */}
        <img 
          src="/Huang_xiao_xian/images/Logo图标 (node-id=142).png"
          alt="Logo"
          style={{
            position: 'absolute',
            width: '24px',
        ...
        {/* 黄小仙来也 Logo文字 */}
        <img 
          src="/Huang_xiao_xian/images/标题字体图片 (node-id=143).png"
          alt="黄小仙来也"
          style={{
            position: 'absolute',
            width: '69px',
        ...
        {/* 右上角装饰图片 */}
        <img 
          src="/Huang_xiao_xian/images/右上角装饰图 (node-id=144).png"
          alt="装饰"
          style={{
            position: 'absolute',
            width: '57px',
        ...
        {/* 总结图标 */}
        <img 
          src="/Huang_xiao_xian/images/总结图标 (node-id=138).png"
          alt="总结"
          style={{
            position: 'absolute',
            width: '11px',
        ...
        {/* 八卦图标 */}
        <img 
          src="/Huang_xiao_xian/images/八卦图标 (node-id=120).png"
          alt="八卦"
          style={{
            position: 'absolute',
            width: '13px',
        ...
        {/* 运势指南图标 */}
        <img 
          src="/Huang_xiao_xian/images/运势指南图标 (node-id=141).png"
          alt="运势指南"
          style={{
            position: 'absolute',
            width: '10px',
        ...
        {/* 人人图标 */}
        <img 
          src="/Huang_xiao_xian/images/人人图标 (node-id=137).png"
          alt="人人"
          style={{
            position: 'absolute',
            width: '11px',
        ...
        {/* 办公图标 */}
        <img 
          src="/Huang_xiao_xian/images/办公图标 (node-id=136).png"
          alt="办公"
          style={{
            position: 'absolute',
            width: '10px',
        ...
        {/* 医疗健康图标 */}
        <img 
          src="/Huang_xiao_xian/images/医疗健康图标 (node-id=121).png"
          alt="医疗健康"
          style={{
            position: 'absolute',
            width: '10px',
        ...
        {/* 爱情运势图标 */}
        <img 
          src="/Huang_xiao_xian/images/爱情运势图标 (node-id=135).png"
          alt="爱情运势"
          style={{
            position: 'absolute',
            width: '10px',
        ...
        {/* 锦鲤券图标 */}
        <img 
          src="/Huang_xiao_xian/images/锦鲤券图标 (node-id=139).png"
          alt="锦鲤券"
          style={{
            position: 'absolute',
            width: '10px',
        ...
        {/* 祭奠蜡烛图标 */}
        <img 
          src="/Huang_xiao_xian/images/祭奠蜡烛图标 (node-id=140).png"
          alt="祭奠蜡烛"
          style={{
            position: 'absolute',
            width: '12px',
